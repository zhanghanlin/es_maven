...
public class Jerseys {
	 ...
	 */
	public static WebApplicationException buildException(Status status,
			String message) {
	 ...
	 */
	public static WebApplicationException buildException(int status,
			String message) {
	 ...
	 */
	public static WebApplicationException buildDefaultException(
			RuntimeException e) {
		if (e instanceof WebApplicationException) {
			return (WebApplicationException) e;
		} else {
			logger.error("Restful Service Error, Status 500:" + e.getMessage(),
					e);
